// TODO: REMOVE THIS FILE. THESE TESTS MOSTLY JUST DUPLICATE SQLREST.RS TESTS.

// use ontodev_sqlrest::{Select as SqlRestSelect, SelectColumn as SqlRestSelectColumn};
...
// #[test]
// fn test_select_new() {
//     let select_new = SqlRestSelect::new("my_table");
//     let expected = SqlRestSelect { table: "my_table".to_string(), ..Default::default() };
//     assert_eq!(select_new.to_url(), expected.to_url());
// }
//
// #[test]
...
//     assert_eq!(select_new.to_url(), clone.to_url());
// }
//
// #[test]
// fn test_select_select() {
//     let mut select = SqlRestSelect::new("my_table");
//     select.select(vec!["v1", "v2", "v3"]);
//     let expected = SqlRestSelect {
//         table: "my_table".to_string(),
//         select: vec![
//             SqlRestSelectColumn::new("v1", None, None),
//             SqlRestSelectColumn::new("v2", None, None),
//             SqlRestSelectColumn::new("v3", None, None),
//         ],
//         ..Default::default()
//     };
//
//     assert_eq!(select.to_url(), expected.to_url());
// }
//
// ////////////////////
//
...
//     select.filter(vec![("a1", Operator::Equals, "b1"), ("a2", Operator::NotEquals, "b2")]);
//     let expected = Select {
//         filter: vec![
...
//     let mut select = Select::new();
//     select.order(vec![("v1", Direction::Ascending), ("v2", Direction::Descending)]);
//     let expected = Select {
//         order: vec![
...
//     let mut select = Select::new();
//     select.limit(1);
//     let expected = Select { limit: 1, ..Default::default() };
//
//     assert_eq!(select, expected);
// }
//
...
//     let mut select = Select::new();
//     select.offset(1);
//     let expected = Select { offset: 1, ..Default::default() };
//
//     assert_eq!(select, expected);
// }
//
...
//     let expected = Select { message: String::from("message"), ..Default::default() };
//
//     assert_eq!(select, expected);
// }
//
...
//         .table("table")
//         .select(vec!["v1", "v2", "v3"])
//         .filter(vec![("a1", Operator::Equals, "b1"), ("a2", Operator::NotEquals, "b2")])
//         .order(vec![("v1", Direction::Ascending), ("v2", Direction::Descending)])
//         .limit(1)
//         .offset(1)
//         .message("message");
//
...
//         select: ["table", "path", "type", "description"].iter().map(|s| s.to_string()).collect(),
//         filter: vec![
...
//     let tables = ["table", "path", "type", "description"].iter().map(|s| s.to_string()).collect();
//     let select = Select { table: "table".to_string(), select: tables, ..Default::default() };
